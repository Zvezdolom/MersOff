...
int main () {
	...
	int count = 0;
	for (int i = 0; i < N; i++) {
		if (students[i].math == 5 && students[i].physics == 5 && students[i].plotting == 5 && students[i].sopromat == 5 && students[i].chemistry == 5) {
			cout << "Студент " << students[i].surname << " " << students[i].name << " " << students[i].second_name << " сдал все экзамены на 5 \n";
			count++;
		}
	}
	cout << "Всего студентов, которые сдали все на 5 - " << count;
}
